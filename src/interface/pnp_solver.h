...
// Estimate the camera pose from 2D-3D correspondences and refine pose with all inliers
//
...
//                       SIMPLE_RADIAL, etc.
// @param params         The focal length, principal point, and extra parameters.
