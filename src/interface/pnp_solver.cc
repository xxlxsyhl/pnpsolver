...
namespace colpnp
{
                          ...
                          std::vector<double> *priors)
    {
        ...
        auto success = colmap::EstimateAbsolutePose(options, points2D, points3D, &qvec, &tvec, &camera, &num_inlier, mask,
        ...
        return colmap::RefineAbsolutePose(refine_options, *mask, points2D, points3D, &qvec, &tvec, &camera);
    }
